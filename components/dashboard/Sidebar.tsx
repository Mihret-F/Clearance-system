...
const NavItem = ({
	...
	const content = (
		...
		>
			...
			{active && (
				<div className="ml-auto w-1.5 h-5 bg-blue-600 dark:bg-blue-400 rounded-full flex-shrink-0" />
			)}
		</div>
	);
		...
		if (
			...
			return [
				{ name: "Dashboard Overview", icon: Home, href: "/dashboard/approver" },
				{
					...
					icon: Clock,
					href: "/dashboard/approver/pending",
					badge: 5,
				},
				{
					name: "Approved Requests",
					icon: CheckCircle,
					href: "/dashboard/approver/approved",
				},
				{
					name: "Rejected Requests",
					icon: XCircle,
					href: "/dashboard/approver/rejected",
				},
				{
					name: "Notifications",
					icon: Bell,
					href: "/dashboard/approver/notifications",
					badge: 2,
				},
				{
					name: "Reports",
