...
const ImageCarousel = () => {
  ...
  const images = [
    "/placeholder.svg?height=1080&width=1920&text=University+Campus",
    "/placeholder.svg?height=1080&width=1920&text=Modern+Library",
    "/placeholder.svg?height=1080&width=1920&text=Historic+Building",
    "/placeholder.svg?height=1080&width=1920&text=Students+Walking",
  ]
...
const ProcessStep = ({ number, title, description, delay = 0 }) => (
  ...
  >
    ...
    {number < 5 && <div className="absolute left-6 top-12 w-0.5 h-16 bg-blue-200 dark:bg-blue-800 ml-[0.3rem]"></div>}
  </motion.div>
)
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      if (featuresRef.current && howItWorksRef.current && faqRef.current) {
        ...
        } else if (scrollPosition >= featuresTop && scrollPosition < howItWorksTop) {
    ...
    <div className={`min-h-screen overflow-x-hidden ${darkMode ? "dark" : ""}`}>
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              <Image src="/university-logo.png" alt="University Logo" width={40} height={40} />
              <span className="text-xl font-bold text-gray-900 dark:text-white">DCS</span>
            </div>
            ...
            <div className="hidden md:flex items-center gap-6">
              <button
                ...
                className={`text-gray-600 hover:text-gray-900 dark:text-gray-300 dark:hover:text-white transition-colors ${activeSection === "home" ? "text-blue-600 dark:text-blue-400 font-medium" : ""}`}
              >
                Home
              </button>
              <button
                onClick={() => scrollToSection(featuresRef)}
                className={`text-gray-600 hover:text-gray-900 dark:text-gray-300 dark:hover:text-white transition-colors ${activeSection === "features" ? "text-blue-600 dark:text-blue-400 font-medium" : ""}`}
              >
                Features
              </button>
              <button
                onClick={() => scrollToSection(howItWorksRef)}
                className={`text-gray-600 hover:text-gray-900 dark:text-gray-300 dark:hover:text-white transition-colors ${activeSection === "howItWorks" ? "text-blue-600 dark:text-blue-400 font-medium" : ""}`}
              >
                How It Works
              </button>
              <button
                onClick={() => scrollToSection(faqRef)}
                className={`text-gray-600 hover:text-gray-900 dark:text-gray-300 dark:hover:text-white transition-colors ${activeSection === "faq" ? "text-blue-600 dark:text-blue-400 font-medium" : ""}`}
              >
                FAQ
              </button>
              <Button asChild>
      ...
      >
        ...
        <div className="container mx-auto px-4 z-20 relative">
          ...
          >
            <h1 className="text-4xl md:text-6xl font-bold mb-6 drop-shadow-lg">University Clearance System</h1>
            <p className="text-xl md:text-2xl mb-8 text-gray-100 drop-shadow-md">Your Hassle-Free Clearance Solution</p>
            <p className="text-lg mb-10 text-gray-200 drop-shadow-sm">
              Manage clearance requests, track approvals, and streamline your process with ease.
            </p>
            <Button size="lg" asChild className="rounded-full text-lg px-8 py-6 hover:scale-105 transition-transform">
              <Link href="/login">
                Get Started
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-gray-600 dark:text-gray-300 max-w-2xl mx-auto text-lg">
              Our digital clearance system offers a range of features to make your clearance process smooth and
              efficient.
            </p>
          </motion.div>
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 to-purple-600">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl mb-8">Join thousands of students using our digital clearance system</p>
            <Button
              size="lg"
              variant="secondary"
              asChild
      ...
      <footer className="bg-gray-900 text-gray-300 py-12">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <h3 className="text-white text-lg font-semibold mb-4">About DCS</h3>
              <p className="text-sm">
                The Digital Clearance System streamlines the university clearance process, making it easier for students
                and faculty.
              </p>
            </div>
            <div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li className="flex items-center gap-2">
                  ...
                  <span className="text-sm">123 University Ave, City</span>
                </li>
                <li className="flex items-center gap-2">
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center">
            <p className="text-sm">© 2024 Digital Clearance System. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
